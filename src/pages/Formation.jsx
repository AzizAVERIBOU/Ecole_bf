...
const Formation = () => {
  ...
  return (
    <div className="container-fluid p-3">
      <section className={`formation-header text-center mb-5 p-5 ${isLargeScreen ? 'card' : ''}`}>
        <div className="formation-header-content container">
          <h1 className="display-4 fw-bold mb-5">Nos Formations</h1>
      ...
      <section className={`container my-5 p-5 ${isLargeScreen ? 'card' : ''}`}>
        <div className="row">
          ...
          <div className="col-lg-6 col-md-12 mb-4">
            <div className="card myCard shadow border-0">
              <article className="card-body text-center p-5 p-md-4">
                ...
                <a target='_blank' href="https://prepas.org/?article=49" className='btn btn-outline-primary'>En savoir plus</a>
              </article>
            </div>
          </div>
          <div className="col-lg-6 col-md-12 mb-4">
            <div className="card myCard shadow border-0">
              <article className="card-body text-center p-5 p-md-4">
                ...
                <a target='_blank' href="https://prepas.org/?article=41" className='btn btn-outline-primary'>En savoir plus</a>
              </article>
            </div>
          </div>
        </div>
